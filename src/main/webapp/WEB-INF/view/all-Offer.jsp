    ...
    <tr>
     ...
     <c:forEach var="temp" items="${allOffers}">
      <tr>
        ...
        <td>${temp.price}</td>
        <td><a href="/Spring_hibernate/deleteOffer?offerId=${temp.id}">Delete</a>
        <a href="/Spring_hibernate/updateOffer?offerId=${temp.id}">Update</a></td>
      </tr>
    ...
    <div class="pagination">
     <ul>
      ...
      <c:forEach begin="${startpage}" end="${endpage}" var="p">
        <a href="<c:url value ="/page"> <c:param name="page" value="${p}"/> </c:url>">${p}
